...
class MainPage(BasePage):
    ...
    @allure.step('Подождать полной загрузки кнопки "Заказать" в хэдере')
    ...
    @allure.step('Подождать полной загрузки части лого с надписью "Самокат" в хэдере')
    def wait_visibility_of_header_logo_scooter(self):
        self.wait_visibility_of_element(MainPageLocators.header_logo_scooter)

    @allure.step('Подождать полной загрузки части лого с надписью "Яндекс" в хэдере')
    ...
    @allure.step('Подождать полной загрузки отображения заголовка главной страницы')
    ...
    @allure.step('Получить титул главной страницы Дзен')
    ...
    @allure.step('Подождать полной загрузки нужного номера вопроса в аккордеоне "Вопросы о важном"')
    ...
    @allure.step('Подождать полной загрузки нужного номера ответа в аккордеоне "Вопросы о важном"')
